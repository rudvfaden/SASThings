...
<#    $processBaseDir  = "F:\database\SeSE"#>
    ...
    $StartInfo.Arguments        = "-CONFIG 'H:\sasconfig\sasren.cfg' -AWStitle '${AWStitle}' ${ALTlog2} -rsasuser -SASINITIALFOLDER 'C:\Users\rfad0001\Documents\My SAS Files\9.4\SAS output'"
