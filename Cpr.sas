proc fcmp outlib=funk.function.funcs;
  ...
  /* prxmatch (perl regular expresion) bruges til validering af cpr nummer.
        Karakteren | indikere 'OR'
        Karakteren \d indikere tal. Dvs. 0-9. Den krøllede parentes angiver hvor mange gange dette gentages. \d{6} giver altså alle 6 cifred tal.
*/
